...
public class SkiSlopeController {
    ...
    @GetMapping("/getSkiSlopesByDifficulty")
    public List<SkiSlope> getSkiSlopesByDifficulty(@RequestParam String difficulty){
        return skiSlopeService.getSkiSlopesByDifficulty(difficulty);
    }
